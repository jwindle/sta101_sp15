...
% ALT ALT
% \[
% \sum_{i=1}^n (y_i - (\tilde b_0 + \tilde b_1 x_i))^2
% \]
...
% ALT ALT - COMMENTED OUT ABOVE, ADDED BELOW
...
% \item \hl{Intercept:} When \underline{$x = 0$}, \underline{$y$} is expected on average to be \underline{the intercept}.
% \[ b_0 = \bar{y} - b_1 \bar{x} \]
% \begin{itemize}
% \item The calculation of the intercept uses the fact the a regression line \textbf{always} passes through $(\bar{x},\bar{y})$.
% \end{itemize}
...
% ALT ALT - COMMENTED ABOVE AND ADDED BELOW

% \item The ``center'' of the cloud of points is always at $(\bar x, \bar y)$.
